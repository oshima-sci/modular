#!/usr/bin/env python3
"""
One-off script to create a new lithium.json with links from the batch CSV.
"""
...
# Paths
CSV_PATH = Path(__file__).parent / "links_batch_20251128_123615.csv"
ORIGINAL_JSON_PATH = Path(__file__).parent.parent.parent.parent / "app" / "public" / "lithium.json"
OUTPUT_JSON_PATH = Path(__file__).parent / "lithium_batch.json"
